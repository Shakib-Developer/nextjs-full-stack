        ...
        <div className="relative py-20 px-4 lg:p-20">
          ...
          <div className="max-w-lg mx-auto text-center">
            <h2 className="mb-4 text-3xl lg:text-4xl font-bold font-heading">
              ...
              <span className="text-red-600">dolor sit</span>
            ...
            <div className="flex flex-wrap max-w-md mx-auto">
              ...
              <button
                className="w-full md:w-auto py-4 px-8 text-xs text-white font-semibold leading-none bg-red-600 hover:bg-red-700 rounded"
                type="submit"
              >
                Sign Up
              </button>
