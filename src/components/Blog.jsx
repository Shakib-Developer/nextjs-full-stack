...
const Blog = ({ data }) => {
  return (
    <section className="relative mx-10 py-20 overflow-hidden">
      <img
      ...
      <div className="relative container ">
        <div className="max-w-lg text-center md:text-left mb-16 ">
        ...
        <div className="grid grid-cols-12 gap-[30px]">
          {data.map((item, index) => (
            <div key={index} className="col-span-4 px-4 mb-8">
              <Link
                className="block max-w-md mx-auto group relative shadow-lg"
              ...
              >
                ...
                <img
                  className="block w-full h-80 rounded-lg object-cover"
                  src={item?.imgCDN}
                  alt=""
                />
              </Link>
