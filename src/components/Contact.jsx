        ...
        <div className="max-w-2xl mx-auto text-center">
          ...
          <div>
            <form onSubmit={handelSubmit}>
              <div className="mb-4">
                <input
                  className="w-full p-4 text-xs font-semibold leading-none bg-gray-200 rounded outline-none"
                  type="text"
                  placeholder="Subject"
              ...
              <div className="mb-4">
                <textarea
                  className="w-full h-40 p-4 text-xs font-semibold leading-none resize-none bg-gray-200 rounded outline-none"
                  type="text"
                  placeholder="Message..."
                  defaultValue={""}
              ...
              <div className="flex justify-between items-center">
                <button
                  className="py-4 px-8 text-sm text-white font-semibold leading-none bg-red-600 hover:bg-red-700 rounded"
                  type="submit"
                >
                  Submit
                </button>
