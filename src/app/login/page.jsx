...
export default function Home() {
  ...
  return (
    <>
      ...
      <section className="py-12 h-screen flex justify-center items-center bg-gray-200">
        <div className="container  mx-auto">
          <div className="flex max-w-md mx-auto flex-col text-center">
            ...
            <form
              ...
              className="mt-12 mb-8 p-8 text-gray-800 rounded"
            >
              <span className="text-sm text-gray-400">Log In</span>
              <h4 className="mb-6 text-3xl text-gray-400">
                Join our community
              </h4>
              ...
              <button
                type="submit"
                className="block w-full p-4 text-center text-xs text-white font-semibold leading-none bg-red-600 hover:bg-red-700 rounded"
              >
                LogIn
              </button>
            </form>
